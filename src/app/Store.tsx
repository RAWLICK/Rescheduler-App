...
const persistConfig = {
    ...
    whitelist: ['LocalStorageInfoSliceReducer', 'StudentInfoSliceReducer', 'ScheduleArraySliceReducer', 'ExistingSubjectsArraySliceReducer', 'StudentsDataArraySliceReducer']       // Specify slices to persist
  };
